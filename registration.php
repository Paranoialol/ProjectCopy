...
<head>
	...
	<noscript>
		<div><img src="https://mc.yandex.ru/watch/64980856" style="position:absolute; left:-9999px;" alt="" /></div>
	</noscript>
				...
				<div class="modal__form">
					...
					<form class="neo_form">
						<div class="main__form_field modal__form_field">
							...
							<input type="text" placeholder="Ваше имя" id="lastname_modal" name="firstname" required value="Paranoia">
						</div>
						<div class="main__form_field modal__form_field">
							<i class="fas fa-user-circle"></i>
						...
						<div class="main__form_field modal__form_field">
							...
							<input type="email" placeholder="E-mail" id="Email_modal" name="email" required value="xvd.jack@rambler.ru">
						</div>
						<div class="main__form_field modal__form_field">
							<div class="form-group">
								<div class="codeWrapper">
									<input type="tel" pattern=".{7,}" minlength="7" class="form-control js-phone" id="phone" name="phone_number" placeholder="Телефон" required>
								</div>
							</div>
						</div>
						...
						<div class="flex_form_wr">
							<form class="flex_form container neo_form">
								<div class="row inputs">
									<div class="col-md-6">
										<i class="fas fa-user-circle"></i>
										<input type="text" name="firstname" placeholder="Ваше имя" id="FirstName_main" value="Paranoia" required>
									</div>
									<div class="col-md-6">
										<i class="fas fa-user-circle"></i>
									...
									<div class="col-md-6">
										<i class="fas fa-envelope"></i>
										<input type="email" placeholder="E-mail" id="Email_main" name="email" required value="xvd.jack@rambler.ru">
									</div>
									<div class="col-md-6">
										<div class="codeWrapper">
											<input type="tel" pattern=".{7,}" minlength="7" class="form-control js-phone" id="phone" name="phone_number" placeholder="Телефон" required>
					...
					<div class="form">
						...
						<form class="form_flex neo_form">
							<div class="form_flex__field">
								<i class="fas fa-user-circle"></i>
								<input type="text" placeholder="Ваше имя" id="FirstName_sec" name="firstname" required="" value="Paranoia">
							</div>
							<div class="form_flex__field">
								<i class="fas fa-user-circle"></i>
							...
							<div class="form_flex__field">
								<i class="fas fa-envelope"></i>
								<input type="email" placeholder="E-mail" id="Email_sec" name="email" required="" value="xvd.jack@rambler.ru">
							</div>
							<div class="form_flex__field">
								<div class="codeWrapper">
									<input class="" type="tel" placeholder="Номер телефона" pattern=".{7,}" minlength="7" id="PhoneNumber_sec" name="phone_number" required>
								</div>
							</div>
